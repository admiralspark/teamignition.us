...
This is a tutorial to try to explain it with a bit less snark than my past post on the subject.
...
SELinux is by no means simple, but with the tools you have here there's no reason you can't work with it in your day-to-day. I hope this covers enough to help get you where you need to be for now! In the future, I may go through building an all-new ruleset by hand for custom applications that cannot be made to work with this, but I have yet to encounter a project that took me more than 15 minutes to build SElinux rules for using the above.
